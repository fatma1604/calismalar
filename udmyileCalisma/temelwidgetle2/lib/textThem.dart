    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            newWidget(), //bunun içinde  butona basma miktarı filan var ctrl. widget
            //fonksiyonlar içinde yapardık

            Text(
              _sayc.toString(),
              style: Theme.of(context).textTheme.bodyLarge,
              //. da dan sonra bürsürü şey var
              //ben kulamam
            ),
          ],
        ),
    ...
    return Column(
      children: [
        Text(
          ...
          //them eklicexz kolaylık sağloıcak
        ),
      ],
    );
  }
